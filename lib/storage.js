...
export default class Store {
  ...
  /**
   * Removes the store instance for the global instances map. If this is the last
  ...
  // eslint does't support the @this jsdoc annotation.
  /*eslint-disable */
  /**
   ...
   */
  storageDidChangeInAnotherWindow(newData, oldData) {
    // Set on instance.
