...
import {assign, createFieldsObj, isObject, isSafari,
    now, uuid} from '../utilities';
...
class PageVisibilityTracker {
  ...
  constructor(tracker, opts) {
    ...
    this.store = Store.getOrCreate(tracker.get('trackingId'),
          'plugins/page-visibility-tracker', {timestampKey: 'time'});
  ...
  handleChange() {
    ...
    this.queue.add(({visibilityState, time}) => {
