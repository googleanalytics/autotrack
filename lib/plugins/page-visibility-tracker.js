...
PageVisibilityTracker.prototype.newSessionDidStart = function() {
  // If the current window/tab is visible, ensure it's stored as the active
  // page and update the current time to avoid reporting time deltas with
  // events in a prior session.
