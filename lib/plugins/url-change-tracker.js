...
function UrlChangeTracker(tracker, opts) {
  ...
  this.opts = defaults(opts, {
    shouldCaptureUrlChange: this.shouldCaptureUrlChange
  });
...
UrlChangeTracker.prototype.updateTrackerData = function(sendPageview) {
  ...
  if (oldPath != newPath &&
      this.opts.shouldCaptureUrlChange.call(this, newPath, oldPath)) {
 ...
 * @return {boolean}
 */
UrlChangeTracker.prototype.shouldCaptureUrlChange = function(newPath, oldPath) {
  return true;
};
