...
import {addHookAfter, removeHookAfter} from '../hooks';
...
class UrlChangeTracker {
  ...
  constructor(tracker, opts) {
    ...
    // Binds methods.
    this.pushStateHook = this.pushStateHook.bind(this);
    this.replaceStateHook = this.replaceStateHook.bind(this);
    this.handlePopState = this.pushStateHook; // Alias for clarity.

    // Watches for history changes.
    addHookAfter(history, 'pushState', this.pushStateHook);
    addHookAfter(history, 'replaceState', this.replaceStateHook);
   ...
   */
  remove() {
    removeHookAfter(history, 'pushState', this.pushStateHook);
    removeHookAfter(history, 'replaceState', this.replaceStateHook);
