...
class UrlChangeTracker {
  ...
  constructor(tracker, opts) {
    ...
    Hook.addAfter(history, 'pushState', this.pushStateHook);
    Hook.addAfter(history, 'replaceState', this.replaceStateHook);
   ...
   */
  remove() {
    Hook.removeAfter(history, 'pushState', this.pushStateHook);
    Hook.removeAfter(history, 'replaceState', this.replaceStateHook);
